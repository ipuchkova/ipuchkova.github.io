var size = 0;
var placement = 'point';
function categories_AmendedCountyCodes_3(feature, value, size, resolution, labelText,
...
var style_AmendedCountyCodes_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("ALL-CODES_Amend-Legend");
    ...
    var style = categories_AmendedCountyCodes_3(feature, value, size, resolution, labelText,
